...
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"assets"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"assets"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"assets"}
